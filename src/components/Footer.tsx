  ...
  return (
    <footer className="relative border-t border-white/6 py-12">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col sm:flex-row justify-between items-start gap-10 mb-10">
          ...
          <div className="max-w-xs">
            <div className="flex items-center gap-2 mb-3">
              <span className="w-8 h-8 rounded bg-red-600 flex items-center justify-center text-white font-bold text-sm shrink-0">
                AN
              </span>
            ...
            <p className="text-xs text-white/35 leading-relaxed">
              Software Developer · Web Designer · AI Enthusiast
            </p>
          </div>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 pt-6 border-t border-white/6">
          <p className="text-xs text-white/20">
            © {year} Adnan Narimukkil. All rights reserved.
          </p>
